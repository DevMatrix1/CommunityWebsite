...
import ankit from "../assets/ankitgit.jpeg"
import shubham from "../assets/shubham.jpeg"
import kotesh from "../assets/kotesh.jpeg"
import udita from "../assets/udita.jpg"
    ...
    <div className=' rounded-xl lg:rounded-3xl p-4 lg:p-10 lg:px-16 mt-8 lg:mt-16  border-yellow-300 border-2 shadow-xl shadow-yellow-300 border-spacing-4 ease-linear gradient1 ' >
     ...
     <div className='grid grid-cols-1  items-center justify-center gap-8 lg:grid-cols-3 mt-8 lg:mt-16'>
        <div className='flex flex-col items-center justify-center   gap-1'>
            <img src={ankit} alt="" className=' rounded-full w-52 h-52' />
        ...
        <div className='flex flex-col items-center justify-center gap-1'>
            <img src={shubham} alt="shubham" className=' rounded-full w-52 h-52' />
        ...
        <div className='flex flex-col items-center justify-center gap-1'>
            <img src={kotesh} alt="kotesh" className=' rounded-full w-52 h-52' />
        ...
        <div className='flex flex-col items-center justify-center gap-1'>
            <img src={udita} alt="udita" className=' rounded-full w-52 h-52' />
        ...
        <div className='flex flex-col items-center justify-center gap-1' >
            <img src={akshay} alt="akshay" className=' rounded-full w-52 h-52' />
